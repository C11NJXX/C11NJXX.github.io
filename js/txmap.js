...
$.ajax({
    ...
    data: {
        key: 'P5HBZ-DZTCT-25ZXD-L3UVK-JLFE5-QEFIL',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    //自定义文本需要放的位置
    document.getElementById("welcome-info").innerHTML = `欢迎来自<span>${pos}</span>的小伙伴，${timeChange}<br>你距离C_11nJxx约有<span>${dist}</span>公里，${posdesc}`;
}
